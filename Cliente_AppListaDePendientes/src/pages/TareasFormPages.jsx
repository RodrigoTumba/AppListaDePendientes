...
import '../App.css';
import { CrearTareas, EliminarTareas, ActualizarTareas, ObtenerTarea, ObtenerTodasLasListas } from "../api/tareas_api";
    ...
    return (
        <div className='container-done'>
            <form onSubmit={onSubmit}>
                ...
                <select {...register("ListaDeTareas", { required: true })}>
                ...
                {errors.ListaDeTareas && <span>La Lista de Tareas es requerida</span>}

                {errors.descripcion && <span>La descripcion es requerida</span>}

                <button disabled="" type="submit" className="btn-guardar text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
